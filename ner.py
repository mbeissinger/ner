...
class OpenNER:
    ...
    @staticmethod
    def __get_entities(data, predictions, vocab_inv, entity_vocab_inv, entity_vocab):
    ...
    def predict(self, query):
        ...
        entities = self.__get_entities(data, predictions, self.inverse_vocab, self.inverse_entity_vocab, self.entity_vocab)
